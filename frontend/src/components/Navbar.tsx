        ...
        <div className="flex items-center justify-between h-16">
              ...
              {session ? (
                ...
                <>
                  <a
                    ...
                    // The button is now disabled if the URL isn't set, preventing errors
                    className={`text-gray-500 border border-gray-400 hover:bg-gray-100 hover:text-gray-800 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 ${!adminPanelUrl ? 'opacity-50 cursor-not-allowed' : ''}`}
                    // Prevent clicking if the URL is not available
                    onClick={(e) => !adminPanelUrl && e.preventDefault()}
                  >
                    Admin Login
                  </a>
                  <Link
          ...
          <div className="-mr-2 flex md:hidden">
            <button type="button" className="bg-white inline-flex items-center justify-center p-2 rounded-md text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500">
              ...
              <svg className="h-6 w-6" xmlns="http://www.w.3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
